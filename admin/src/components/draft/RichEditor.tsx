...
const RichEditor: FC<{ onChange: (data: RawDraftContentState) => void, content?: RawDraftContentState }> = ({ onChange, content }) => {
    ...
    const handleCodeBlock = () => {
        setEditorState((state) => {
            ...
            content = Modifier.setBlockData(content, selection, Map({ "language": "golang" }))

            const newEditorState = EditorState.push(editorState, content, "change-block-data");
    ...
    useEffect(() => { setEditorState(convertData(content)) }, [content])
